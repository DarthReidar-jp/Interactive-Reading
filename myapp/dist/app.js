...
const bookDisplay_1 = __importDefault(require("./routes/bookDisplay"));
...
app.use(express_1.default.urlencoded({ limit: '50mb', extended: true })); // URLエンコードされたボディのサイズ制限を増やす
...
app.use('/writer', writer_1.default);
app.use('/bookDisplay', bookDisplay_1.default);
