...
exports.getAllFoldersAndMemos = exports.getAllBooks = exports.getAllMemos = exports.getAllFolders = void 0;
// dataFetchUtils.ts
...
function getAllBooks() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const booksCollection = yield (0, dbUtils_1.getDBCollection)('books');
            const books = yield booksCollection.find({}).toArray();
            return { books };
        }
        catch (e) {
            // エラーがErrorインスタンスかどうかをチェック
